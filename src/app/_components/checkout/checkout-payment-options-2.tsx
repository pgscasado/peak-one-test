...
import StateProvinceSelect from "./checkout-state-selector-2";
import GuarantyImg from '@/../public/images/guaranty-seal.jpg';
    ...
    <>
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="flex flex-row w-full align-middle mb-4">
          ...
          <div className="">
            <p className='font-bold text-[16px]'>Shipping Information</p>
            <p>Where Do We Send Your Order</p>            
          </div>
        </div>
          ...
          <div className="flex w-full flex-col items-start justify-start relative">
            ...
            <div className="relative w-full">
              <select
                ...
                className="w-full border-[1px] border-[#333]  px-2 py-2 text-[16px] sm:text-[14px] rounded-sm bg-white"
        ...
        <div className="flex w-full space-x-4 mt-6">
          <div className="flex w-full flex-col items-start justify-start">
            ...
            <input
              ...
              className="w-full border-[1px] border-[#333] px-2 py-2 text-[16px] sm:text-[14px] mb-2 rounded-sm"
              placeholder="Address"
            />
            ...
            <input
              ...
              className="w-full border-[1px] border-[#333] px-2 py-2 text-[16px] sm:text-[14px] rounded-sm"
        ...
        <div className="flex flex-row w-full align-middle my-4">
          <LockClosedIcon className="h-[32px] w-[32px] mr-2 my-auto" />
          <div className="">
            <p className='font-bold text-[16px]'>Payment Options</p>
        ...
        <input
          ...
          className="text-[18px] bg-[#29af5c] w-full py-4 mt-4 rounded-lg text-white font-bold green-text-shadow border-b-[3px] border-[#128e41] cursor-pointer hover:bg-[#0ebf52]"
        />
      </form>
