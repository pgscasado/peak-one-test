  ...
  return (
    <>
        ...
        <div className="flex flex-row w-full align-middle mb-4">
          <UserIcon className="h-[32px] w-[32px] mr-2 my-auto" />
          <div className="">
            <p className='font-bold text-[16px]'>Customer Information</p>
        ...
        <div className="flex w-full space-x-4">
          <div className="flex w-1/2 flex-col items-start justify-start">
            ...
            <input
              ...
              className="w-full border-[1px] border-[#333]  px-2 py-2 text-[16px] rounded-sm sm:text-[14px]"
